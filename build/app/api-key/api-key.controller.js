...
class ApiKeyController extends crud_controller_1.CrudController {
    constructor(service) {
        super(service);
        this.router = express.Router();
        this.path = api_consts_1.API_VERSION_PATH;
        this.collectionName = database_consts_1.COLLECTION_API_KEY;
    ...
    async initRouter() {
        ...
        this.router.post(`/${this.collectionName}/`, [
            firebase_auth_middleware_1.firebaseAuthMiddleware,
            (0, validator_middleware_1.validateRequest)(api_key_model_1.apiKeyCreateSchema)
        ], this.call('createOne'));
        ...
        this.router.put(`/${this.collectionName}/:_id`, [
            firebase_auth_middleware_1.firebaseAuthMiddleware,
            (0, validator_middleware_1.validateParams)(query_validator_1.paramsSchema),
            (0, validator_middleware_1.validateRequest)(api_key_model_1.apiKeyUpdateSchema)
        ], this.call('updateOne'));
    }
}
