...
exports.apiKeyUpdateSchema = exports.apiKeyCreateSchema = void 0;
const joi_1 = __importDefault(require("joi"));
exports.apiKeyCreateSchema = joi_1.default.object({
    name: joi_1.default.string().required(),
    key: joi_1.default.string().required(),
    keyType: joi_1.default.string().required(),
    expiration: joi_1.default.date().required(),
});
exports.apiKeyUpdateSchema = joi_1.default.object({
