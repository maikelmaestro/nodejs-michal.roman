...
class UserController extends crud_controller_1.CrudController {
    constructor(service) {
        ...
        this.collectionName = database_consts_1.COLLECTION_USER;
    ...
    async initRouter() {
        ...
        this.router.post(`/${this.collectionName}/`, [
            firebase_auth_middleware_1.firebaseAuthMiddleware,
            (0, validator_middleware_1.validateRequest)(user_model_1.userCreateSchema)
        ...
        this.router.put(`/${this.collectionName}/:_id`, [
            firebase_auth_middleware_1.firebaseAuthMiddleware,
            (0, validator_middleware_1.validateParams)(query_validator_1.paramsSchema),
            (0, validator_middleware_1.validateRequest)(user_model_1.userUpdateSchema)
        ], this.call('updateOne'));
    }
}
